...
from tasks.forms import TaskForm, PhotoForm
...
class TaskListView(ListView):
    ...
    def get_queryset(self):
        ...
        update_at = self.request.GET.get("update_at")
        if update_at:
            queryset = queryset.filter(update_at__date=update_at)
...
def add_photo_to_task(request, pk):
    ...
    if request.method == "POST":
        ...
        form = PhotoForm()
    return render(request, "add_photo_to_task.html", {"form": form})
